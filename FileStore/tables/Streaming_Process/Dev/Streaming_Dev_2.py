    ...
    try:
        if status_code == 420:
            ...
            try:
                ...
                q1 = """update control_stream set status = 2 WHERE program_name = 'Streaming_Dev_2.py' """
                q2 = """update control_stream set status = 1 WHERE program_name = 'Streaming_Dev_1.py' """
                ...
                cursor.close()
                connection.close()
                subprocess.Popen("python3 /dbfs/FileStore/tables/Streaming_Process/Dev/Streaming_Dev_1.py", shell=True)
...
TWITTER_CONSUMER_KEY = secret["Consumer_Key_Dev_2"]
TWITTER_CONSUMER_SECRET = secret["Consumer_Secret_Dev_2"]
TWITTER_ACCESS_TOKEN = secret["Access_Token_Dev_2"]
TWITTER_ACCESS_TOKEN_SECRET = secret["Access_Token_Secret_Dev_2"]

...
def get_max_id():
    try:
        ...
        if old_max_id == "None":
          ...
          with open("/dbfs/FileStore/tables/Streaming_Process/Dev/OldMaxId_Dev.py", "w") as fw:
...
def polling():
        ...
        old_max_id = open('/dbfs/FileStore/tables/Streaming_Process/Dev/OldMaxId_Dev.py').read().strip()
        ...
        if int(new_max_id) > int(old_max_id):
            ...
            #sp = subprocess.run(["pkill", "-f", "python3 /dbfs/FileStore/tables/Streaming_Process/Dev/Streaming_Dev.py"])    
            #print("sp.returncode: ", sp.returncode)  
            with open("/dbfs/FileStore/tables/Streaming_Process/Dev/OldMaxId_Dev.py", 'w') as fp:
            ...
            if pgrm_name == 'Streaming_Dev_1.py':
                sp = subprocess.run(["pkill", "-f", "python3 /dbfs/FileStore/tables/Streaming_Process/Dev/Streaming_Dev_1.py"]) 
                time.sleep(0.05)
                if sp.returncode == 0:
                ...
                sp = subprocess.run(["pkill", "-f", "python3 /dbfs/FileStore/tables/Streaming_Process/Dev/Streaming_Dev_2.py"]) 
                time.sleep(0.05)
                if sp.returncode == 0:
